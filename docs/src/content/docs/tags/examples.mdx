---
title: Example Tags
description: A few example tags.
sidebar:
    order: 5
---
...
The following tag shows an example of using the various attributes listed in
...
This simple tag shows how to store repeated/informational text.
This tag has often been used in a support server.
